...
describe("<Footer />", () => {
    it("render the <Footer /> with populated data", () => {
      ...
      <Footer.Text>Notflix Vietnam | hphuocthanh</Footer.Text>
        ...
        expect(getByText("Questions? Contact me.")).toBeTruthy()
        expect(getByText("My Github")).toBeTruthy()
        expect(getByText("My Facebook")).toBeTruthy()
        expect(getByText("My Linkedin")).toBeTruthy()
        expect(getByText("My Twitter")).toBeTruthy()
